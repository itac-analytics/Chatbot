...
const Home = () => {
  ...
  const handleFileInputChange = (event) => {
    ...
    // Check file type
    const allowedTypes = ['text/plain', 'application/msword', 'application/pdf', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'];
    if (allowedTypes.includes(selectedFile.type)) {
      console.log('Selected file:', selectedFile);
      setUploadedFiles([...uploadedFiles, selectedFile]);
    } else {
      alert('Please upload files of type txt, doc, docx, or pdf.');
    }
    handleCloseDialog();
        ...
        <div className="flex mb-4">
          <div>
            <button
              ...
              className="block mb-2 p-2 bg-gray-200 rounded-md hover:bg-gray-300 focus:outline-none"
            >
              Attach Files
            </button>
                  ...
                  <div className="flex items-center justify-center min-h-screen">
                    <div className="bg-white rounded-lg p-4 max-w-sm w-full">
                      ...
                      <button
                        ...
                        className="block w-full p-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none"
                      >
                        Choose File
                      </button>
                      <button
                        onClick={handleCloseDialog}
                        className="block w-full mt-2 p-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 focus:outline-none"
                      >
                        Cancel
                      </button>
                    </div>
